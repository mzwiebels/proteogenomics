...
formatParams = function(params){
	...
	cellPrev = strsplit(params[grepl("Clonal cluster cellular prevalence",rownames(params)),1]," ")[[1]]
	...
	return(list(id=id,barcode=barcode,numClust=numClust,cellPrev=cellPrev,purity=purity,norm=norm,ploidy=ploidy,loglik=loglik,sdbw=sdbw))
}
