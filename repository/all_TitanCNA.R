...
suppressPackageStartupMessages(require(TitanCNA,quietly=TRUE,warn.conflicts=FALSE))
...
suppressPackageStartupMessages(require(doMC,quietly=TRUE,warn.conflicts=FALSE))
#suppressPackageStartupMessages(require(SNPchip,quietly=TRUE,warn.conflicts=FALSE))
