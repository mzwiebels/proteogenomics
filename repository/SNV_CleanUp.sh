...
if [ $analysis = 'Mutect2' ]; then
	if [ $runmode = 'MS' ]; then
		...
		rm $name/results/Mutect2/$name.m2.vcf.stats
		rm $name/results/Mutect2/$name.m2.f1r2.tar.gz
		...
		rm $name/results/Mutect2/$name.m2.filt.vcf.filteringStats.tsv
		...
		rm $name/results/Mutect2/$name.Mutect2.vcf.idx
		...
		rm $name/results/Mutect2/$name.$type.m2.vcf.stats
		rm $name/results/Mutect2/$name.$type.m2.f1r2.tar.gz
		rm $name/results/Mutect2/$name.$type.m2.filt.vcf
		rm $name/results/Mutect2/$name.$type.m2.filt.vcf.idx
		rm $name/results/Mutect2/$name.$type.m2.filt.vcf.filteringStats.tsv
	...
	rm $name/results/Manta/runWorkflow.py.config.pickle
	rm $name/results/Manta/workflow.*
